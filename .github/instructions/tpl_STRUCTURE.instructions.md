---
description: 'Template for the STRUCTURE documentation for a product.'
applyTo: '/docs/STRUCTURE.md'
---

#  { PRODUCT_NAME } STRUCTURE

Structure Document for { Product name }
...
```
{ Root Source folder }
├── { folder1 }/       # { brief description of folder1 }
├── { folder2 }/       # { brief description of folder2 }
└── { folder3 }/       # { brief description of folder3 }
```
